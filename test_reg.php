   ...
   $req_fields = array('class_select','username','password','re_password','first_name','last_name','email');
    ...
    foreach($_POST as $key=>$value){
        ...
        $err[] = 'Fält med en asterix måste fyllas i';
            ...
            $err[]= 'Lösenordet måste innehålla 6 tecken';
        } 
            ...
            $err[] = 'Email-adressen \''. $_POST['email']. '\' är upptagen.';
            }
        }
    }
}
...
if(isset($_GET['success']) && empty($_GET['success'])){
        ...
        echo "<center><strong>Du är nu registrerad!</strong><br>Kolla din E-Mail för aktiveringsstatus<br><form method='post' action='test_index.php'><input type='submit' name='back' value='Tillbaka'></center>";
} else {
...
<div class="form">   
    <form action="" method="post">
        <ul>
            ...
            <li>
                   <input type="submit" class="submit" name="submit" value="Registrera">
