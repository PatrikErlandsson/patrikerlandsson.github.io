        ...
        if(!empty($name)){
          ...
          if(!is_dir($location.$studentid."/"))
          {
              ...
              chmod($location.$studentid."/", 0777);
               ...
               echo "<div class='main-content'>Uppladdad till studentid: ".$studentid."</div>";
           }
...
?>
    ...
    <main>
        <div class="main-banner">
            <h2 class="banner_title">Lärare</h2>
            </div>
...
<form action="teacher.php" method="POST" enctype="multipart/form-data">
    ...
    <input type='submit' id ="send_file" class="submit" value='Skicka fil'>
...
echo "<ul><table><thead><tr><th scope='col'>Kontroll av skickade filer:</th></tr></thead>";
