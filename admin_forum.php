...
?>
    ...
    <main>
        <div class="main-banner">
            <h2 class="banner_title">Forum</h2>
...
//make function
    ...
    if(!$result)
    {
        ...
        echo "<center><div class='main-content' style='color: red;'>Ej postad! Felaktigt ifylld</div></center>";
    }
    else
    {
        echo "<center><div class='main-content'>Ny post tillagd</div></center>";
...
?>
        ...
        <tr><th scope='col'>Ämne:</th><th scope='col'>Innehåll:</th></tr>
           ...
           <tbody><form method='post' action=''>
            ...
            <tr><th scope='row'><input type='submit' class='submit' name='submit' value='Lägg till'/></th><th scope='row'></th></tr>
            </form>
