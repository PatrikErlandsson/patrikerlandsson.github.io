...
function activate_class_count(){
    ...
    echo "<tr><th scope='row'>".$row->first_name."</th><td> ".$row->last_name."</td><td><a href=mailto:".$row ->email. "' style='color:#A17890;'>" .$row ->email. "</a></td><th scope='row'><form method='post' action='admin.php'><input type='submit'name='submit' class='submit' value='aktivera student'><input type='hidden' name='uid' value='".$row->id."'/><input type='hidden' name='activateuser' class='submit' value='true'/></form></th></tr>"; 
     /*   
...
function delete_class_count(){
    ...
    echo "<tr><th scope='row'>".$row->first_name."</th><td> ".$row->last_name."</td><td><a href=mailto:".$row ->email. "' style='color:#78A189;'>" .$row ->email. "</a></td><th scope='row'><form method='post' action='admin.php'><input type='submit'name='submit'value='Deaktivera student' class='submit'><input type='hidden' class='submit' name='uid' value='".$row->id."'/><input type='hidden' name='deleteuser' class='submit' value='true'/></form></th></tr>"; 
